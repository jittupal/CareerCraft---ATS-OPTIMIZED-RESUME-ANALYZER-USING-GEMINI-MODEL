...
with col2:
   ...
   #   img_resized = img.resize((200, 130))  # Resize to width 250px and height 150px
...
with col1:
    img1 = Image.open("icon5.png")
   #  img1_resized = img1.resize((200, 130))  # Resize to width 250px and height 150px
    st.image(img1, use_column_width=True, width=150)
...
with col2:
    ...
    st.image(img2, use_column_width=True, width=200)  # Adjust the width
...
with col1:
    img3 = Image.open("icon3.png")
    st.image(img3, use_column_width=True, width=200)  # Adjust the width
